        ...
        {{-- Por el momento esto lo pueden ver todos, mas adelante se agregará control de permisos --}}
            <div>
                <a href="{{ $module['route'] !== '#' ? route($module['route']) : '#' }}"
                   class="flex items-center p-3 rounded-lg transition-colors {{ request()->routeIs($module['active']) ? 'bg-blue-50 text-blue-600 font-bold' : 'text-gray-600 hover:bg-gray-100' }}">
